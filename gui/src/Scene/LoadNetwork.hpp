...
public:
  ...
  void onEnter() override {
    ...
    Texture &loadingAsset =
        _texManager.get("gui/assets/loadingNetworkSheat.png");
  ...
  void draw(Shader &shader, WindowSize &windowSize) override {
    ...
    _loadingSprite->position =
        Zappy::Math::vec3(WIDTH / 2.0f, HEIGHT / 2.0f, 0.0f);
