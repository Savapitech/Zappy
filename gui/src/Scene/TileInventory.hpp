...
public:
  tileInventory(TextureManager &tm, Zappy::NetworkManager &nm, FontManager &fm)
      : _texManager(tm), _fontManager(fm) {
    (void)nm;
  }
  ...
  void setTargetTile(const Zappy::Tile &tile) { _target = tile; }
